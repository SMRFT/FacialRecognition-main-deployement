...
function Addemp() {
  ...
  const departments = ["IT", "DOCTOR", "NURSE", "HR", "LAB", "RT TECH", "PHARMACY", "TELECALLER", "FRONT OFFICE", "SECURITY", "ELECTRICIAN", "ACCOUNTS", "NURSING", "HOUSE KEEPING", "DENTIST CONSULTANT", "COOK"];
  ...
  <div className="col-sm-6">
    ...
    <div className="row">
        ...
        <div className="col-sm-6">
              ...
              <Col>
                <div className="mb-3">
                  ...
                  <div className="col-sm-7">
                    ...
                    />
                    <div style={{ color: "red", marginLeft: "55%", marginTop: "-4%" }}>{validateLanguages(languages) ? <p>{validateLanguages(languages)}</p> : null}</div>
                  </div>
                </div>
            ...
            <span style={{ font: "caption", fontStyle: "italic", fontFamily: "-moz-initial", fontSize: "20px" }}>
    Choose a PAN or Aadhaar proof:
</span>
...
<br/>
            ...
            <div className="mx-5 form-group">
            <span style={{ font: "caption", fontStyle: "italic", fontFamily: "-moz-initial", fontSize: "20px" }}>
            Choose a Certificates (multiple file select) :
</span>
...
<Form.Field>
            ...
            <Col>
            <div style={{ marginTop:"-60px" ,font: "caption", fontStyle: "italic", fontFamily: "-moz-initial", fontSize: "20px"}} className="mx-5 form-group">
